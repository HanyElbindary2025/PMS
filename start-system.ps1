...
Write-Host "    PMS System Startup" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""

Write-Host "Step 1: Starting Backend Server..." -ForegroundColor Green
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd D:\projects\PMS; npm run dev" -WindowStyle Normal
...
Start-Process powershell -ArgumentList "-NoExit", "-Command", "cd D:\projects\PMS\pms_app; flutter run -d web-server --web-port 8080" -WindowStyle Normal
