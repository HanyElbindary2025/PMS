...
lookupsRouter.get('/', async (req: Request, res: Response) => {
...
// Admin: create
lookupsRouter.post('/', async (req: Request, res: Response) => {
...
// Admin: update
lookupsRouter.put('/:id', async (req: Request, res: Response) => {
  const { id } = req.params;
...
// Admin: delete
lookupsRouter.delete('/:id', async (req: Request, res: Response) => {
  const { id } = req.params;
