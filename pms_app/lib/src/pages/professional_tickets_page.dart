...
class _ProfessionalTicketsPageState extends State<ProfessionalTicketsPage> {
  ...
  // Show testing assignment dialog
  Future<Map<String, dynamic>?> _showTestingAssignmentDialog() async {
    final commentController = TextEditingController();
    String? selectedAssigneeId;
    List<String> selectedTeamMembers = [];
    List<Map<String, dynamic>> users = [];
        ...
        builder: (context, setState) => AlertDialog(
          title: Row(
            children: [
              ...
              const SizedBox(width: 8),
              const Text('Assign to Testing Team'),
            ],
          ),
          content: SingleChildScrollView(
            child: Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.start,
              children: [
                const Text('Assign this ticket to a testing team member:'),
                const SizedBox(height: 16),
                ...
                TextField(
                  controller: commentController,
                  decoration: const InputDecoration(
                    hintText: 'Optional comment about testing assignment...',
                    border: OutlineInputBorder(),
                  ),
                  maxLines: 2,
                ),
          ...
          actions: [
            ...
            ElevatedButton(
              ...
              child: const Text('Assign & Move to Testing'),
            ),
          ],
        ),
      ),
