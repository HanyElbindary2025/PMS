...
echo.
echo ========================================
echo    PMS System Startup
echo ========================================
echo.

echo Step 1: Starting Backend Server...
start "Backend Server" cmd /k "cd /d D:\projects\PMS && npm run dev"
...
start "Flutter Frontend" cmd /k "cd /d D:\projects\PMS\pms_app && flutter run -d web-server --web-port 8080"
